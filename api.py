...
cotacao_dolar = cotacoes['USDBRL']["bid"] # Solicitnado a cotação em Dolar
print(f'Cotaçao do Dolar atual: R$ {cotacao_dolar}') # Mostrando a cotação em Dolar

cotacao_euro = cotacoes['EURBRL']["bid"] # Solicitnado a cotação em Euro
print(f'Cotaçao do Euro atual: R$ {cotacao_euro}') # Mostrando a cotação em Euro

cotacao_bitcoin = cotacoes['BTCBRL']["bid"] # Solicitnado a cotação em Bitcoin
